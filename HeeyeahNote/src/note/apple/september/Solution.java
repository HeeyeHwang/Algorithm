...
public class Solution {
	...
	public String solution_success(String[] participant, String[] completion) {
		String answer = null;
	...
	public static void main(String[] args) {
		...
		String[] phoneBook = new String[] {"1235","123","12","567", "88"};
		
		boolean d = new Solution().solution(phoneBook);
