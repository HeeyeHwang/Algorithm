...
public class Solution {
	 ...
	 * 있습니다. 입출력 예 participant completion return [leo, kiki, eden] [eden, kiki] leo
	 * [marina, josipa, nikola, vinko, filipa] [josipa, filipa, marina, nikola]
	 * vinko [mislav, stanko, mislav, ana] [stanko, ana, mislav] mislav 입출력 예 설명 예제
	 ...
	 * Solution.java
	 * 
	 * 1 class Solution { 2 public String solution(String[] participant, String[]
	 * completion) { 3 String answer = ""; 4 return answer; 5 } 6 } 실행 결과 실행 결과가 여기에
	 * 표시됩니다.
	 */
	...
	public String solution_fail(String[] participant, String[] completion) {
		String answer = null;
