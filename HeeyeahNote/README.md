...
그 중 '위장' 이라는 문제가 있는데, 이건 어떻게 풀지 감이 안와서 이것저것 뒤져서 참고한 결과.. 수학 문제라는 느낌 :) 알아두면 좋을 방법이긴 하다.
같은 분류의 것이 a,b / c, d, e 라고 하면(0, a, b) = 선택안함, a선택, b선택 총 3가지의 경우가 있고 마찬가지로 하면 두번째 집단은 4가지이다. 여기서 아무것도 선택안하는 경우는 없으니 3*4 -1 = 11 이 된다는 말!
<br/>
<br/>
