...
문제 풀면서 간과했던 중요한 조건 중 하나가 **2명만 탈 수 있다** 는 것인데, 2명이기 때문에 max와 min의 조합으로 생각해서 풀 수 있는 것 같다. 만약 2명이라는 제약 조건이 없었으면, limit를 최대한 맞추기 위해 경우의 수를 생각해야 했을 것이다. ~~(그게 내가 삽질한 포인트기도 하다.)~~
<br/><br/>
